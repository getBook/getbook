...
public class FaceConversionUtil {
	...
	/** 保存于内存中的表情集合 */
	public static List<ChatEmoji> emojis = new ArrayList<ChatEmoji>();
	...
	public SpannableString addFace(Context context, int imgId,
		...
		Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(),
				imgId);
		bitmap = Bitmap.createScaledBitmap(bitmap, (int) MyUtils.dp2px(context, 25f),  (int) MyUtils.dp2px(context, 25f), true);
		ImageSpan imageSpan = new ImageSpan(context, bitmap);
		SpannableString spannable = new SpannableString("[em]" + spannableString + "[/em]");
	 ...
	 * @param data
	 */
	public static  void ParseData(List<String> data, Context context) {
		if (data == null) {
			return;
		}
		if (emojis.size() > 0) {
