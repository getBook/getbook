...
public class ImageLoader {
    ...
    private static final int TAG_KEY_URI = R.id.icon;
    ...
    private Handler mMainHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            ImageView iv = (ImageView) gv.findViewWithTag(result.uri);
            if (null != iv && null != result.bitmap) {
    ...
    private Bitmap loadBitmapFromLocal(String url, int reqWidth, int reqHeight) {
        ...
        int scaleSize = mImageResizer.calculateInSampleSize(options, reqWidth, reqHeight);
